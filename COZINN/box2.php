...
{
	mysqli_query($al,"INSERT INTO box2 VALUES('','$name','$msg','$date')");
}
$fetch=mysqli_query($al,"SELECT * FROM box2 ORDER BY id ASC");
...
<head>
    ...
    <title>Fine Arts Chat | COZINN</title>
    ...
    <div align="center">
        <form method="post" action="">
            <table class="table" cellpadding="4" cellspacing="4">
                <tr>
                    <td align="center" class="tableHead" colspan="2">Fine Arts Chat</td>
                </tr>
                <tr>
                    <td colspan="2">
