...
{
	mysqli_query($al,"INSERT INTO box3 VALUES('','$name','$msg','$date')");
}
$fetch=mysqli_query($al,"SELECT * FROM box3 ORDER BY id ASC");
    ...
    <div align="center">
        <form method="post" action="">
            <table class="table" cellpadding="4" cellspacing="4">
                <tr>
                    <td align="center" class="tableHead" colspan="2">Music Chat</td>
                </tr>
                <tr>
                    <td colspan="2">
