...
{
	mysqli_query($al,"INSERT INTO box6 VALUES('','$name','$msg','$date')");
}
$fetch=mysqli_query($al,"SELECT * FROM box6 ORDER BY id ASC");
...
<head>
    ...
    <title>Doubts Chat | COZINN</title>
    ...
    <div align="center">
        <form method="post" action="">
            <table class="table" cellpadding="4" cellspacing="4">
                <tr>
                    <td align="center" class="tableHead" colspan="2">Doubts Chat</td>
                </tr>
                <tr>
                    <td colspan="2">
